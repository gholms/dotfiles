...
syn keyword	pfCmd		altq anchor antispoof pass
syn keyword	pfCmd		queue scrub table set match
...
syn keyword	pfWildAddr	all any self
syn match	pfCmd		/block\s/
syn match	pfCmd		/binat-to\s/
syn match	pfCmd		/nat-to\s/
syn match	pfCmd		/rdr-to\s/
